...
print("Accuracy of naive Bayes classifier for the test data is ", accuracy[0])
print("Precision of naive Bayes classifier for the test is ", precision[0], "\n")

pred = model.predict(x_train)
accuracy.append(get_accuracy(y_train, pred))
precision.append(get_precision(y_train, pred))

print("Accuracy of naive Bayes classifier for the train datas is ", accuracy[1])
print("Precision of naive Bayes classifier for the train datas is ", precision[1], "\n")
...
plt.title('Accuracy and Precision of Naive Bayes Classifier')
